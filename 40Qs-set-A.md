...
**Foundation Level Compatible with Syllabus version 4.0.1**
...
* $${\color{green}c.\ To\ reduce\ the\ risk\ level\ of\ the\ test\ object\ and\ to\ build\ confidence\ in\ the\ quality\ level}$$  
...
* $${\color{green}a.\ Having\ testers\ involved\ during\ various\ software\ development\ lifecycle\ (SDLC)\ activities\ will\ help\ to\ detect\ defects\ in\ work\ products}$$  
...
* $${\color{green}b.\ i,\ iii\ and\ v\ are\ important}$$  
...
* $${\color{green}d.\ Testers\ help\ business\ representatives\ to\ create\ suitable\ acceptance\ tests}$$
...
* $${\color{green}d.\ In\ sequential,\ incremental,\ and\ iterative\ development\ models}$$
...
* $${\color{green}c.\ In\ ATDD,\ tests\ are\ created\ based\ on\ acceptance\ criteria\ to\ drive\ the\ development\ of\ the\ related\ software}$$  
...
* $${\color{green}d.\ Writing\ a\ test\ script\ before\ setting\ up\ the\ configuration\ management\ process}$$
...
* $${\color{green}c.\ Process\ weaknesses\ identified\ during\ the\ retrospective\ can\ be\ analyzed\ and\ serve\ as\ a\ to\ do\ list\ for\ the\ organization’s\ continuous\ process\ improvement\ program}$$  
...
* b)  Only 5, 7  
* c)  Only4,6,8,9  
* $${\color{green}d.\ Only\ 5,\ 6}$$

**Question #15**  
Which of the following is NOT a benefit of static testing?

* $${\color{green}a.\ Having\ less\ expensive\ defect\ management\ due\ to\ the\ ease\ of\ detecting\ defects\ later\ in\ the\ SDLC}$$  
...
* $${\color{green}d.\ It\ helps\ avoid\ requirements\ misunderstandings}$$
...
* $${\color{green}d.\ Failures\ found\ should\ be\ acknowledged,\ appreciated,\ and\ handled\ objectively}$$
...
* $${\color{green}c.\ The\ test\ techniques\ heavily\ rely\ on\ the\ tester’s\ knowledge\ of\ the\ software\ and\ the\ business\ domain}$$  
...
**Question #23**  
You test a system whose lifecycle is modeled by a state transition diagram. What is the MINIMAL number of test cases to achieve valid transitions coverage?
...
**Question #24**  
Your test suite achieved 100% statement coverage. What is the consequence?
...
* $${\color{green}d.\ White-box\ testing\ can\ help\ identify\ gaps\ in\ requirements\ implementation}$$

**Question #26**  
Which of the following BEST describes the concept behind error guessing?

* $${\color{green}a.\ Error\ guessing\ involves\ using\ your\ knowledge\ and\ experience\ of\ defects\ found\ in\ the\ past\ and\ typical\ errors\ made\ by\ developers}$$  
* b) Error guessing involves using your personal experience of development and the errors you made as a developer  
* c) Error guessing requires you to imagine that you are the user and guess errors the user could make  
...
**Question #27**  
In your project there has been a delay in the release of a brand-new application. Which test technique fits BEST?

* a) Checklist-based testing  
* b) Error guessing  
* $${\color{green}c.\ Exploratory\ testing}$$  
* d) Branch testing

**Question #28**  
Which of the following BEST describes the way acceptance criteria can be documented?

* a) Performing retrospectives to determine the actual needs of the stakeholders  
* $${\color{green}b.\ Using\ the\ given/when/then\ format\ to\ describe\ an\ example\ test\ condition\ related\ to\ a\ given\ user\ story}$$  
* c) Using verbal communication to reduce the risk of misunderstanding  
* d) Documenting risks related to a given user story in a test plan

**Question #29**  
User story example: Editor reviews content. Which is the BEST example of an ATDD test?
...
* d) Test if the editor can reassign to another editor

**Question #30**  
How do testers add value to iteration and release planning?

* a) Testers determine the priority of the user stories  
* b) Testers focus only on functional aspects  
* $${\color{green}c.\ Testers\ participate\ in\ the\ detailed\ risk\ identification\ and\ risk\ assessment\ of\ user\ stories}$$  
* d) Testers guarantee the release of high-quality software

**Question #31**  
Which TWO options are exit criteria for testing a system?

* a) Test environment readiness  
* b) Ability to log in to the test object  
...
**Question #32**  
Your team uses three-point estimation: Optimistic 2h, Most Likely 11h, Pessimistic 14h. Final estimate?

* a) 9h  
* b) 14h  
* c) 11h  
* $${\color{green}d.\ 10\ person-hours}$$

**Question #33**  
You are testing a mobile app with test priorities and dependencies:

| Test case | Priority | Dependency |
| --- | --- | --- |
| TC001 | 3 | none |
| TC002 | 2 | TC001 |
| TC003 | 1 | TC002 |
...
Which test case should be executed third?
...
A. Q1: technology facing, supporting dev  
B. Q2: business facing, supporting dev  
...
**Question #35**  
Risk: Response time too long. Risk likelihood: medium; impact: high. Response: testing & end-user sampling. Measure?
...
**Question #36**  
Which work product shows completed and remaining work for an agile iteration?

* a) Acceptance criteria  
* b) Defect report  
* c) Test completion report  
* $${\color{green}d.\ Burndown\ chart}$$

**Question #37**  
Updating an automated test script to meet a new requirement. Which process indicates creating a new version in the repository?

* a) Traceability management  
* b) Maintenance testing  
* $${\color{green}c.\ Configuration\ management}$$  
* d) Requirements engineering

**Question #38**  
Defect report is rejected as not reproducible. Missing critical info useful for developers?
...
* b) Test analysis  
* $${\color{green}c.\ Test\ design\ and\ test\ implementation}$$  
* d) Test completion

**Question #40**  
Potential risk of performing test automation?

* a) It may introduce unknown regressions in production  
* $${\color{green}b.\ Sufficient\ efforts\ to\ maintain\ testware\ may\ not\ be\ properly\ allocated}$$  
