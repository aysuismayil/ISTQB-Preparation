...
“for every SDLC activity there is a corresponding test activity”.  
In which SDLC models does this rule hold?
...
$${\color{green}b.\ Splitting\ large\ work\ products\ into\ small\ parts\ to\ make\ the\ required\ effort\ less\ intense}$$  
...
$${\color{green}a.\ During\ white-box\ testing\ the\ entire\ software\ implementation\ is\ considered}$$  
...
c) Error guessing requires you to imagine that you are the user of the test object  
d) Error guessing requires you to rapidly duplicate the development task  
...
a) Performing retrospectives  
$${\color{green}b.\ Using\ the\ given/when/then\ format\ to\ describe\ an\ example\ test\ condition}$$  
...
b) Test if the content owner can log in  
c) Test if the editor can schedule the edited content  
...
a) Testers determine the priority  
...
d) Testers guarantee the release  
